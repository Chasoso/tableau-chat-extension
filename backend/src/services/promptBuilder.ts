...
export function buildPrompt(
  ...
  return [
    ...
    options.investigationQuestion ? `Tool-planning question: ${options.investigationQuestion}` : "",
    options.evaluationSummary ? `Evidence evaluation: ${options.evaluationSummary}` : "",
    options.evidenceGaps?.length ? `Remaining evidence gaps: ${options.evidenceGaps.join("; ")}` : "",

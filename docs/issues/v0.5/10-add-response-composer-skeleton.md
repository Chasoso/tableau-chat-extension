...
- ResponseComposer should remain deterministic in v0.5.0.
- It summarizes JSON-safe context tool results into a placeholder response for `selected_mark_explanation`.
- LLM generation, Bedrock, and Tableau MCP are out of scope.
